...
if minetest.get_modpath("3d_armor") then
   armor:register_armor("sapphire:helmet_sapphire", {
			   ...
			   groups = gsconf.sapphire_armor.groups_helmet,
			   armor_groups = gsconf.sapphire_armor.armor_groups_helmet,
			   damage_groups = gsconf.sapphire_armor.dmg_groups_helmet,
   })

   armor:register_armor("sapphire:leggings_sapphire", {
			   description = ("Sapphire Leggings"),
			   inventory_image = "sapphire_leggings_inv.png",
			   groups = gsconf.sapphire_armor.groups_leggings,
			   armor_groups = gsconf.sapphire_armor.armor_groups_leggings,
			   damage_groups = gsconf.sapphire_armor.dmg_groups_leggings,
   })
   ...
   armor:register_armor("sapphire:chestplate_sapphire", {
			   ...
			   groups = gsconf.sapphire_armor.groups_chest,
			   armor_groups = gsconf.sapphire_armor.armor_groups_chest,
			   damage_groups = gsconf.sapphire_armor.dmg_groups_chest,
   })

   armor:register_armor("sapphire:boots_sapphire", {
			   description = ("Sapphire Boots"),
			   inventory_image = "sapphire_boots_inv.png",
			   groups = gsconf.sapphire_armor.groups_boots,
			   armor_groups = gsconf.sapphire_armor.armor_groups_boots,
			   damage_groups = gsconf.sapphire_armor.dmg_groups_boots,
   })

   armor:register_armor("sapphire:shield_sapphire", {
			   description = ("Sapphire Shield"),
			   inventory_image = "sapphire_shield_inv.png",
			   groups = gsconf.sapphire_armor.groups_shield,
			   armor_groups = gsconf.sapphire_armor.armor_groups_shield,
			   damage_groups = gsconf.sapphire_armor.dmg_groups_shield,
   })
