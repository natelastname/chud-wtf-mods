...
function amtac.notify_all_of_cheater(player, reason)
   print(dump(reason))
   minetest.chat_send_all(minetest.colorize("#FF0000", "[AMTAC] " .. player:get_player_name() .. " was caught using " .. reason))
end


local debug_mode = minetest.settings:get("anticheat_debug") or false
