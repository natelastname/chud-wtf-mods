...
minetest.register_node("mcl_jukebox:jukebox", {
	...
	groups = {oddly_breakable_by_hand=1,choppy=1, container=7, deco_block=1, material_wood=1, flammable=-1},
...
mcl_jukebox.register_record("Cold Beer Calling My Name", "Luke Combs", "far", "mcl_jukebox_record_far.png", "mcl_jukebox_track_4")
